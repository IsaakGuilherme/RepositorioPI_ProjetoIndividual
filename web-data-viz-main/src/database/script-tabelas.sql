-- database do projeto individual
...
(1, 'Neymar', 3),
(1, 'Rodrygo', 4),
(2, 'Libertadores 2011', 1),
(2, 'Brasileirão 2002', 2),
(2, 'Mundial de 1962', 3),
(2, 'Paulista 2015', 4),
(3, 'Pelé', 1),
(3, 'Pepe', 2),
(3, 'Ganso', 3),
(3, 'Giovanni', 4),
(4, 'Tradicional branca', 1),
(4, 'Listrada preta e branca', 2),
(4, 'Camisa azul (terceiro uniforme)', 3),
(4, 'Rosa comemorativa', 4),
(5, 'Vila Belmiro', 1),
(5, 'Maracanã', 2),
(5, 'Morumbi', 3),
(5, 'Neo Química Arena', 4),
(6, 'Anos 60 (Pelé, Pepe...)', 1),
(6, 'Anos 2000 (Diego, Elano...)', 2),
(6, 'Anos 2010 (Neymar, Ganso...)', 3),
(6, 'Atual (Marcos Leonardo, Deivid...)', 4),
(7, 'Corinthians', 1),
(7, 'Palmeiras', 2),
(7, 'São Paulo', 3),
(7, 'Flamengo', 4),
(8, 'Final da Libertadores 2011', 1),
(8, 'Santos 5x4 Flamengo (2011)', 2),
(8, 'Santos 3x1 Corinthians (Paulista 2015)', 3),
(8, 'Santos 4x2 Grêmio (Libertadores 2010)', 4),
(9, '"Agora quem dá bola é o Santos"', 1),
(9, '"Santos, Santos, gol!"', 2),
(9, '"Vamos Santos, vamos ser campeão"', 3),
(9, '"Sou Santos até morrer"', 4),
(10, 'Rodrygo', 1),
(10, 'Kaiky', 2),
(10, 'Marcos Leonardo', 3),
(10, 'Ângelo', 4);

insert into usuario (nome, email, senha) values
('isaak', 'isaak@admin.com', '1234'),
